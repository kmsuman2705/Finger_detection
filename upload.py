...
# Define absolute paths for the upload directory and subdirectories
base_dir = "/var/www/cgi-bin/myupload/"
...
try:
    ...
    if image_file.filename:
        ...
        filename = f"myimage_{timestamp}.png"
        ...
        is_known = False  # Modify this logic based on your actual method to determine known images

        if is_known:
            new_path = os.path.join(known_dir, filename)
            os.rename(filepath, new_path)
            print("<p>Image is known and saved in 'known' directory.</p>")
        else:
            print("<p>Image is new and saved in 'new' directory.</p>")
        ...
        img_path = os.path.join(new_dir, filename) if not is_known else os.path.join(known_dir, filename)
        ...
        if img is None:
            ...
            if results.multi_hand_landmarks:
                ...
                debug_image_path = os.path.join(new_dir, "debug_image.png")
